...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  { dtKey: "gt_debtcons_dt", dt: "Debt Consolidation", ddKey: "gt_debtcons_dd", dd: "Using mortgage financing to pay out higher-interest debts. It may lower monthly payments but can extend debt over a longer period." },
  ...
  { dtKey: "gt_equity_dt", dt: "Equity", ddKey: "gt_equity_dd", dd: "The difference between market value and debts secured against the property." },
  ...
  { dtKey: "gt_heloc_dt", dt: "HELOC", ddKey: "gt_heloc_dd", dd: "Home equity line of credit. A revolving credit line secured by real estate." },
  ...
  { dtKey: "gt_refinance_dt", dt: "Refinance", ddKey: "gt_refinance_dd", dd: "Changing or replacing a mortgage, often to access equity, consolidate debt, or change structure." },
  { dtKey: "gt_renewal_dt", dt: "Renewal", ddKey: "gt_renewal_dd", dd: "Choosing a new term when the current mortgage term ends." },
  { dtKey: "gt_secondm_dt", dt: "Second Mortgage", ddKey: "gt_secondm_dd", dd: "A mortgage registered behind the first mortgage. It usually has a higher rate due to higher lender risk." },
